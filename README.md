...
**ulackroad video compressor** is part of the **BlackRoad OS** ecosystem — a sovereign, distributed operating system built on edge computing, local AI, and mesh networking by **BlackRoad OS, Inc.**
...
```bash
curl -O https://raw.githubusercontent.com/BlackRoad-OS/blackroad-video-compressor/main/blackroad-video-compressor.sh
chmod +x blackroad-video-compressor.sh
./blackroad-video-compressor.sh
```
